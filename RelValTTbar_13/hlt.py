# hltGetConfiguration /users/sdonato/PVsort/NewPV/V4 --output full --input root://eoscms.cern.ch//store/relval/CMSSW_10_1_0_pre3/RelValTTbar_13/GEN-SIM-DIGI-RAW/PU25ns_101X_upgrade2018_realistic_v3-v1/10000/96DCB897-6029-E811-9805-0025905B8564.root --globaltag 101X_upgrade2018_realistic_v3 --unprescale

# /users/sdonato/PVsort/NewPV/V4 (CMSSW_10_0_4)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sdonato/PVsort/NewPV/V4')
)
...
process.hltPixelVerticesUnsorted = cms.EDProducer( "PixelVertexProducer",
...
process.hltTrackWithVertexRefSelectorBeforeSorting = cms.EDProducer( "TrackWithVertexRefSelector",
    ...
    ptMax = cms.double( 9.0E99 ),
    d0Max = cms.double( 999.0 ),
    copyExtras = cms.untracked.bool( False ),
    nVertices = cms.uint32( 0 ),
    vertexTag = cms.InputTag( "hltPixelVerticesUnsorted" ),
...
process.hltPixelVertices = cms.EDProducer( "RecoChargedRefCandidatePrimaryVertexSorter",
...
process.HLT_NewPVSorting_v1 = cms.Path( process.hltTriggerType + process.hltOnlineBeamSpot + process.hltPixelVerticesUnsorted + process.hltTrackWithVertexRefSelectorBeforeSorting + process.hltTrackRefsForJetsBeforeSorting + process.hltPixelVertices + process.hltBoolEnd )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_NewPVSorting_v1, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://eoscms.cern.ch//store/relval/CMSSW_10_1_0_pre3/RelValTTbar_13/GEN-SIM-DIGI-RAW/PU25ns_101X_upgrade2018_realistic_v3-v1/10000/96DCB897-6029-E811-9805-0025905B8564.root',
    ),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '101X_upgrade2018_realistic_v3')
...
_customInfo['globalTag' ]= "101X_upgrade2018_realistic_v3"
_customInfo['inputFile' ]=  ['root://eoscms.cern.ch//store/relval/CMSSW_10_1_0_pre3/RelValTTbar_13/GEN-SIM-DIGI-RAW/PU25ns_101X_upgrade2018_realistic_v3-v1/10000/96DCB897-6029-E811-9805-0025905B8564.root']
