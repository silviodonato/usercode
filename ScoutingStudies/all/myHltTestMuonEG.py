...
process.HLTPixelOnlyPFScoutingSequence = cms.Sequence( process.HLTAK4PixelOnlyPFJetsSequence + process.hltPixelOnlyPFMETProducer )

process.HLTPFScoutingPixelTrackingSequence = cms.Sequence( process.HLTAK4CaloJetsSequence + process.HLTPixelOnlyPFScoutingSequence + process.HLTPixelOnlyPFScoutingPackingSequence )

process.HLTPixelOnlyPFScoutingPackingSequence = cms.Sequence( process.hltScoutingTrackPacker + process.hltScoutingPrimaryVertexPacker + process.hltScoutingPFPacker )
...
process.hltOutputScoutingPF = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "outputScoutingPF_MuonEG_test_full_pt%d.root"%value ),
...
_customInfo['inputFile' ]=  ["file:/eos/cms/store/data/Run2023D/MuonEG/RAW/v1/000/369/978/00000/5041cc41-2a64-42d8-8df1-8345743189c8.root"]
