...
#options.inputFiles = ["outputSimTrack__.root"]
#options.inputFiles = ["outputSimTrack.root"]
#options.inputFiles = ["outputSimTrack_noAddTracks.root"]

inputFiles = [
    "/data/user/sdonato/Wpipipi_RAW/Wpipipi_RAW/Wpluspipipi_RAW2023_29.root",
#    "outputSimTrack_test3_OOB_fewFED_newListMerger_pt0.root",
#    "outputSimTrack_test3_OOB_pt0.root",
#    "outputSimTrack_test3_OOB_fewFED_pt0.root",
#    "outputSimTrack_test3_fix_allFED_HP_test_4_pt0.root",
#    "outputSimTrack_test2_noTIBTID_only6_TEC16_pt0.root",
#    "outputSimTrack_test3_fix_allFED_HP_test_4_pt0.root",
#    "outputSimTrack_test3_fix_allFED_HP_test_3_pt0.root",
#    "outputSimTrack_test3_fix_allFED_HP_test_pt0.root",
#    "outputSimTrack_test3_fix_allFED_HP_pt0.root",
#    "outputSimTrack_test3_fix_allFED_HP_pt3.root",
#    "outputSimTrack_test3_fix_allFED_HP_pt7.root",
#    "outputSimTrack_test3_fix_allFED_HP_pt999.root",
#    "outputSimTrack_test3_fix_pt3.root",
#    "outputSimTrack_test3_fix_allFED_pt3.root",
#    "outputSimTrack_test3_pt3.root",
#    "outputSimTrack_test3_noMod_pt0.root",
#    "outputSimTrack_test3_pt0.root",
#    "outputSimTrack_test2_noTIBTID_only6_TEC16_pt7.root",
#    "outputSimTrack_test2_noTIBTID_only6_TEC16_pt0.root",
#    "outputSimTrack_test2_noTIBTID_only6_TEC16_loose_vtxTrimmed_pt0.root",
#    "outputSimTrack_test2_noTIBTID_only6_TEC16_loose_vtxFalse_pt0.root",
#    "outputSimTrack_test2_noTIBTID_only6_TEC16_loose_pt0.root",

#    "outputSimTrack_test_noTIBTID_only6_TEC16_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC26_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC36_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC46_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC56_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC76_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC86_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC96_pt7.root",

#    "outputSimTrack_test_noTIBTID_only6_TEC12_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC13_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC14_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC15_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC16_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC17_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC18_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC19_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC1_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC2_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC3_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC4_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC5_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC6_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC7_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC8_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC9_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC37_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC3_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC7_pt7.root",
#    "outputSimTrack_test_noTIBTID_only2_TEC37_pt7.root",
#    "outputSimTrack_test_noTIBTID_only6_TEC37_pt7.root",
    #"outputSimTrack_test_all_pt0.root",
    #"outputSimTrack_test_all_pt7.root",
    #"outputSimTrack_test_all_pt999.root",
    #"outputSimTrack_test_firstHalf_pt0.root",
    #"outputSimTrack_test_noSingle_noTIBTID_pt0.root",
    #"outputSimTrack_test_noSingle_noTIBTID_pt7.root",
    #"outputSimTrack_test_noSingle_noTIBTID_pt999.root",
    #"outputSimTrack_test_noSingle_pt0.root",
    #"outputSimTrack_test_noSingle_pt7.root",
    #"outputSimTrack_test_noSingle_pt999.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOBAnd3_TEC37_pt7.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOBAnd3_TEC3_pt7.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOBAnd3_TEC7_pt7.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOBAndTwo_noTEC_pt0.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOBAndTwo_noTEC_pt7.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOBAndTwo_noTEC_pt999.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOB_noTEC_pt0.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOB_noTEC_pt7.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOB_noTEC_pt999.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOB_pt7.root",
    #"outputSimTrack_test_noTIBTID_onlyLastTOB_pt999.root",
    #"outputSimTrack_test_noTIBTID_pt0.root",
    #"outputSimTrack_test_noTIBTID_pt7.root",
    #"outputSimTrack_test_noTIBTID_pt999.root",
    #"outputSimTrack_test_pt0.root",
    #"outputSimTrack_test_pt999.root",
    #"outputSimTrack_test_secondHalf_pt0.root"
]
...
for inputFile in inputFiles:
    ...
    #options.inputFiles = ["outputSimTrack_original.root"]
    ...
    histos = {}
    for name in ["SimTrack", "ScoutingTrack", "SimTracktrk", "HLTPFlow", "HLTtrack", "HLTpixelTrack"]:
        histos[name] = tmp.Clone(name)

    histos["SimTrack"].SetLineColor(ROOT.kRed)
    histos["ScoutingTrack"].SetLineColor(ROOT.kBlue)
    histos["SimTracktrk"].SetLineColor(ROOT.kBlack)
...
#        if len([obj for obj in scoutingTracks.product()])<3: continue
    ...
    #    simTracks = simTracks.product()
    #    photons = photons.product()
        
#        print("SimTrack")
#        try:
        if True:
            pion_p = max([obj for obj in simTracks.product() if obj.charge()==1], key=lambda obj: obj.momentum().pt())
            pion_m = max([obj for obj in simTracks.product() if obj.charge()==-1], key=lambda obj: obj.momentum().pt())
            pion_3 = max([obj for obj in simTracks.product() if abs(obj.charge())==1 and obj!=pion_p and obj!=pion_m], key=lambda obj: obj.momentum().pt())
            mass = invariant_mass3(pion_p.momentum().pt(), pion_m.momentum().pt(), pion_3.momentum().pt(), pion_p.momentum().eta(), pion_m.momentum().eta(), pion_3.momentum().eta(), pion_p.momentum().phi(), pion_m.momentum().phi(), pion_3.momentum().phi(), pion_mass, pion_mass, pion_mass)
        else:
#        except:
            mass = -1
        histos["SimTrack"].Fill(mass)
#        1/0
##        print("SimTracktrk")
#        try:
#            pion_p = max([obj for obj in simTracks.product() if obj.pdgId()==211], key=lambda obj: obj.pt()+obj.trk_pt())
#            pion_m = max([obj for obj in simTracks.product() if obj.pdgId()==-211], key=lambda obj: obj.pt()+obj.trk_pt())
#            pion_3 = max([obj for obj in simTracks.product() if abs(obj.pdgId())==211 and obj!=pion_p and obj!=pion_m], key=lambda obj: obj.pt()+obj.trk_pt())
...
#        pion = max([obj for obj in simTracks.product() if abs(obj.pdgId())==211], key=lambda obj: obj.pt() + obj.trk_pt())
...
#            break
    ...
    histos[first].Fit(f1, "", "", m - 3*s, m + 3*s)
