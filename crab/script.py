...
for i in sequence :
     ...
     if exit_code == 0 :
       ...
       if exit_code != 0:
           crabFiles[i] = crabFiles[i].replace("cms-xrd-global.cern.ch","xrootd-cms.infn.it")
           print crabFiles[i],
           exit_code = launch("edmFileUtil "+crabFiles[i])
           if exit_code != 0:
               crabFiles[i] = crabFiles[i].replace("xrootd-cms.infn.it","cmsxrootd.fnal.gov")
               print crabFiles[i],
               exit_code = launch("edmFileUtil "+crabFiles[i])
               if exit_code != 0:
                   print "REMOVED"
...
for i in sequence :
     ...
     if exit_code == 0 :
       ...
       if exit_code != 0:
           crabSecondaryFiles[i] = crabSecondaryFiles[i].replace("cms-xrd-global.cern.ch","xrootd-cms.infn.it")
           print crabSecondaryFiles[i],
           exit_code = launch("edmFileUtil "+crabSecondaryFiles[i])
           if exit_code != 0:
               crabSecondaryFiles[i] = crabSecondaryFiles[i].replace("xrootd-cms.infn.it","cmsxrootd.fnal.gov")
               print crabSecondaryFiles[i],
               exit_code = launch("edmFileUtil "+crabSecondaryFiles[i])
               if exit_code != 0:
                   print "REMOVED"
...
launchNtupleFromMINIAOD("tree.root",crabFiles,maxEvents, crabSecondaryFiles)
