# wget https://raw.githubusercontent.com/cms-steam/SteamRatesEdmWorkflow/master/Rates/Menu_HLT.py

from Menu_HLT import groupMap
...
for path in paths:
    path_cleaned = path[:path.rfind("_v")]+"_v"
    groups = []
    try:
        groups = groupMap[path_cleaned]
    except:
        pass
    print(path+"\t", ",".join(groups))
