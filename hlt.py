# /users/sdonato/Hbb2017/HLT/V31 (CMSSW_9_1_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/sdonato/Hbb2017/HLT/V31')
)
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = '90X_upgrade2017_TSG_Hcal_V3', conditions = 'L1Menu_Collisions2017_dev_r5_m4_patch_xml,L1TUtmTriggerMenuRcd,frontier://FrontierProd/CMS_CONDITIONS,,9999-12-31 23:59:59.000')
