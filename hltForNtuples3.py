...
process.HLT_HbbOpen_v1 = cms.Path( process.HLTBeginSequence + process.hltPreHbbOpen + process.HLTAK4CaloJetsSequence + process.HLTRecoMETSequence + process.hltMet + process.hltMht + process.hltHtMht + process.HLTHBHENoiseCleanerSequence + process.hltMetClean + process.HLTNoPUSequence + process.hltMHTNoPU + process.HLTBtagCSVSequenceL3 + process.hltBTagCaloCSVp067Single + process.HLTAK4PFJetsSequence + process.HLTBtagCSVSequencePF + process.hltPFMHTTightID + process.hltPFMETProducer + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_HbbOpen_v1, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://eoscms.cern.ch//eos/cms/store/mc/PhaseIFall16DR/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v2/130000/064423AD-EB10-E711-988F-0025904B26A8.root',
    ),
...
_customInfo['inputFile' ]=  ['root://eoscms.cern.ch//eos/cms/store/mc/PhaseIFall16DR/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v2/130000/064423AD-EB10-E711-988F-0025904B26A8.root']
